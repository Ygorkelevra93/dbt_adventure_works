with rename as(
    ...
    --,FCT_VENDAS_DATA_ATT as "Data Faturamento Att Registro"
    ...
    --,FCT_VENDAS_NUMERO_REVISAO as "Numero Revisão"
    ...
    --,FCT_VENDAS_COD_APROV_CARTAO as "Cód. Aprov Cartão"
    --,FCT_VENDAS_OBSERVACOES as "Observações da Venda"
